...
class Trakr {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-trakr-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-trakr-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		#require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-trakr-public.php';

		$this->loader = new Trakr_Loader();
